...
* **Sumarização:** Geração automática de resumos a partir de textos longos.
* **Tradução:** Tradução automática entre idiomas utilizando modelos pré-treinados.
* **Geração de Texto:** Geração de texto a partir de um prompt inicial.
...
Cada ficheiro é independente e pode ser executado diretamente com `python chapterOne/<ficheiro>.py`.
